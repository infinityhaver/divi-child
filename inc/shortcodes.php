...
// [ffw_button]
function ffw_button( $atts, $content ) {
...
add_shortcode( 'ffw_button', 'ffw_button' );
...
function youtube( $atts, $content ) {
	...
	$clean_embed 	= substr($embed_url, 0, strpos($embed_url, "&"));
	return '<div class="ffw-video"><iframe src="' . $clean_embed . '" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>';
}
