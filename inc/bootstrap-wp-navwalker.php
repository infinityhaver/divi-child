<?php
/**
 * WP Bootstrap Navwalker - Dropdown chevrons for mobile added by FFW
 *
 * @package Divi Child
 */
...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) {
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			/**
			 * Dropdown chevron (for mobile)
			 */
			$item_output .= ( $args->has_children && 0 === $depth ) ? '<span data-toggle="dropdown" class="caret-toggle"><i class="fas fa-chevron-down"></i></span>' : '';
